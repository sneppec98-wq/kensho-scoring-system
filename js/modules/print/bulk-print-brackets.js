...
export const bulkPrintBrackets = async (eventId, eventName, eventLogo) => {
    ...
    try {
        ...
        // Sort brackets based on classes order
        ...
        printWindow.document.write(`
            ...
            <body>
                <button class="print-btn no-print" onclick="window.print()">CETAK SEMUA BAGAN (F4 LANDSCAPE)</button>
                ${contentHtml}
                <script>
